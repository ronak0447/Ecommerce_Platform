...
export const createProduct = (productData) =>async(dispatch)=>{
  try {
    ...
    const{data}= await axios.post(`/api/admin/addproduct`,productData,config);
    dispatch({
...
export const updateProduct = (id,productData) =>async(dispatch)=>{
  try {
    ...
    const{data}= await axios.put(`/api/admin/update/${id}`,productData,config);
    dispatch({
...
export const getAllReviews = (id) =>async(dispatch)=>{
  try {
    ...
    const{data}= await axios.get(`/api/productreview?id=${id}`);
...
export const deleteReviews = (reviewId,productId) =>async(dispatch)=>{
  try {
    ...
    const{data}= await axios.delete(`/api/productreview/delete?reviewid=${reviewId}&productId=${productId}`);
